...
- **`hash(A, B)`** is a cyberlink reference —  it allows treating the edge as a particle you can point at. An addressable edge can then be hashed together with others into a **composite particle**.
